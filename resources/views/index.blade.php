      ...
      <div class="col-md-4">
        <div class="card mb-4" style="text-align: center; box-shadow: none !important;">
          <div class="card-body" style=" box-shadow: none !important;">
            ...
            <p style="margin-bottom: 0.5rem; font-size: 0.875rem;">{{$company->type}}, {{$company->location->state}}</p>
            @else
            <p style="margin-bottom: 0.5rem; font-size: 0.875rem;">{{$company->type}}, {{$company->location->state}}, {{$company->location->country}}</p>
            @endif

...
<div class="py-5">
  <div class="container">
    <h2><a href="/profile">Profile</a> @if(Auth::user()->company_id == 0)<a href="/claim" style="margin-left: 1rem;">Claim Company</a>@endif <a href="/companies/add-company" style="margin-left: 1rem;">Create Company</a> <a href="/jobs/add-job" style="margin-left: 1rem;">Create Job</a> <span style="text-decoration: underline; margin-left: 1rem;">Dashboard</span>
    </h2>
    <br/>

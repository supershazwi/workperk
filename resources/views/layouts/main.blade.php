      ...
      <div class="navbar navbar-white bg-white">
        <div class="container d-flex justify-content-between">
          <a href="/" style="color: #212529;"><h5 class="navbar-brand d-flex align-items-center">
            Work<strong>Perk</strong><img class="mb-2" src="/img/falling-star.svg" alt="" width="24" height="24" style="transform: rotate(180deg); margin-left: 0.5rem;">
          </h5></a>
          <div>
          ...
          <footer class="">
            <div class="row">
              <div class="col-12 col-md">
                <img class="mb-2" src="/img/falling-star.svg" alt="" width="24" height="24" style="transform: rotate(180deg);">

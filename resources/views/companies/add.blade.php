...
<div class="py-5">
  <div class="container">
    <h2><a href="/profile">Profile</a>  @if(Auth::user()->company_id == 0)<a href="/claim" style="margin-left: 1rem;">Claim Company</a>@endif <span style="text-decoration: underline; margin-left: 1rem;">Create Company</span> <a href="/jobs/add-job" style="margin-left: 1rem;">Create Job</a> <a href="/dashboard" style="margin-left: 1rem;">Dashboard</a>
    </h2>
    <br/>
